...
public class ParoleController {
    ...
    void doInsert(ActionEvent event) {
    	...
    	txtPerformance.appendText("doInsert time = " + (System.nanoTime()-start) + "\n");
    }
    ...
    void doCancella(ActionEvent event) {
    	...
    	for(String s : elenco.getElenco())
    		txtResult.appendText(s + "\n");
    	txtPerformance.appendText("doCancella time = " + (System.nanoTime()-start) + "\n");
    }
    ...
    void doReset(ActionEvent event) {
    	...
    	for(String s : elenco.getElenco())
    		txtResult.appendText(s + "\n");
    	txtPerformance.appendText("doReset time = " + (System.nanoTime()-start) + "\n");
    }
